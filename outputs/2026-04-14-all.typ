...
// SLUGS: cursor-dictation-vs-clipboard-stt-adoption, custom-vocabulary-in-stt, dictation-formatting-built-in-vs-supplementary, batch-vs-chunked-inference-accuracy, focus-loss-during-dictation, voice-dictation-hotkey-count-tradeoffs, stt-enthusiastic-industry-adoption, inference-cadence-and-sentence-entry, live-typing-models-saas-and-local, local-stt-builtin-vad, local-stt-inference-engines-gpu, pause-tolerant-dictation-profile-and-stack, streaming-vs-batch-injection, vad-for-live-typing, partial-transcript-rewriting, handy-inference-vs-typing-delay, whisper-vs-streaming-asr-for-dictation
